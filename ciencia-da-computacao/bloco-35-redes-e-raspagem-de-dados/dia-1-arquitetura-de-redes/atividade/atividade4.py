# Exercício 4 : Agora iremos para a camada de transporte. Crie um servidor TCP
...
# Perceba que o servidor sozinho não faz nada.
# Ele precisa que alguém se conecte a ele,
# então para testá-lo você pode utilizar o comando telnet localhost 8085 ,
# onde telnet é a aplicação que iremos utilizar, localhost é o local onde o
# servidor está (no caso, o seu próprio PC)
# e 8085 é a porta em que o servidor está escutando conexões.
# Dicas:
# a documentação do módulo traz exemplos de como instanciar seu servidor TCP
# na mesma documentação, temos exemplos de classes para
# responder as requisições
# os dados na requisição vêm em bytes -- não strings! bytes podem ser
...
if __name__ == "__main__":
    # usando with nosso TCPServer vai arrumar a
    # casa direitinho quando encerrado
