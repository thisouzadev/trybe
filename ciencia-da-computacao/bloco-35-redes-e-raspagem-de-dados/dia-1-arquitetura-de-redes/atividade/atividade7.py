# Exercício 7 : Agora iremos explorar o outro protocolo
# de transporte que aprendemos.
# Crie um servidor UDP usando o mesmo módulo socketserver .
# Nosso servidor UDP deverá:
# Imprimir no console toda mensagem recebida (não esqueça
# de converter também para string).
