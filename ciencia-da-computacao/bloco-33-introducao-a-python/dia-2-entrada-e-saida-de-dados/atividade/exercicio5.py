# Exercício 5:
# Utilizando o arquivo pokemons.json , vamos
# escrever um programa que sorteie um pokemon aleatoriamente.
# O programa deve perguntar à pessoa usuária "Quem é esse pokemon?",
# até que ela o acerte. A cada erro, apresente um número de
