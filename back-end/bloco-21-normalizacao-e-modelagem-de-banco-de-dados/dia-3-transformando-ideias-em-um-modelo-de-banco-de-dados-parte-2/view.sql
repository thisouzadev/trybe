-- Crie uma view chamada film_with_categories utilizando as 
-- tabelas category , film_category e film do banco de dados sakila . 
...
-- Crie uma view chamada address_info que faça uso das tabelas address e city
...
-- Crie uma view chamada movies_languages , usando as tabelas film e language do banco 
-- de dados sakila . Sua view deve exibir o título do filme , o id do idioma e o idioma do filme ,
