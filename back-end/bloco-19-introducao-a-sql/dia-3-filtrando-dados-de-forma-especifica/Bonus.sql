USE Scientists;
-- Escreva uma query para exibir todas as informações de todos os cientistas que possuam a 
-- letra e em seu nome.
...
WHERE Code LIKE 'A%'
ORDER BY Name ASC;
-- Escreva uma query para exibir o código e nome de todos os projetos que possuam em seu código 
...
-- Escreva uma query para exibir o nome e o código de todos os projetos cujo nome 
-- NÃO inicie com a letra A .
SELECT * FROM Projects
