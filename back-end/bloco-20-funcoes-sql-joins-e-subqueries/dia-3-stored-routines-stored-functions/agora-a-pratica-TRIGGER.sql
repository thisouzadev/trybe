...
-- da tabela movies como o ano atual de forma dinâmica, 
...
-- de 'Increasing' . Caso contrário, insira o valor 'Decreasing' .
...
BEGIN
SET NEW.ticket_price_estimation = IF(NEW.ticket_price > OLD.ticket_price, 'Increasing', 'Decreasing');
INSERT INTO movies_logs(movie_id, executed_action, logdate)
VALUES(NEW.movie_id,'UPDATE', NOW());
END $$
DELIMITER ;
