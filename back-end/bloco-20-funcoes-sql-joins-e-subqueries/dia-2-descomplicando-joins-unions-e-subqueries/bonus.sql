-- Exercício 10: Utilizando o INNER JOIN , selecione todas as informações dos filmes
-- com avaliação maior que 8 e que estejam em cartaz.
USE Pixar;
...
-- Exercício 11: Utilizando o SELF JOIN , selecione os títulos e duração dos filmes 
-- que possuem o mesmo diretor.
USE Pixar;
